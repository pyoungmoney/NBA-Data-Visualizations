...
all_data.to_csv('nba_team_advanced_stats_1996_to_2023.csv', index=False)
print("Data for all seasons from 1996-97 to 2022-23 for both Regular Season and Playoffs has been successfully parsed and saved to 'nba_team_advanced_stats_1996_to_2023.csv'")
