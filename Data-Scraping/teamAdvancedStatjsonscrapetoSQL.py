...
def create_table(conn, df):
    ...
    cursor.execute("SELECT EXISTS (SELECT FROM pg_tables WHERE schemaname = 'public' AND tablename  = 'Team Advanced Stats');")
    ...
    # If the table does not exist, proceed with creation
        ...
        sql_command = f"""
        CREATE TABLE "Team Advanced Stats" (
...
def insert_data(conn, df):
    ...
    sql_command = f'INSERT INTO "Team Advanced Stats" ({columns}) VALUES %s;'
