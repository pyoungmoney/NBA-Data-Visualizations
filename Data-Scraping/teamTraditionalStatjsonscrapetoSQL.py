...
def create_table(conn, df):
    ...
    cursor.execute("SELECT EXISTS (SELECT FROM pg_tables WHERE schemaname = 'public' AND tablename  = 'Team Traditional Stats');")
    ...
    # If the table does not exist, proceed with creation
        ...
        sql_command = f"""
        CREATE TABLE "Team Traditional Stats" (
...
def insert_data(conn, df):
    ...
    sql_command = f'INSERT INTO "Team Traditional Stats" ({columns}) VALUES %s;'
